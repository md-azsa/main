...
//
Figure 17 below shows the outcome of executing the `addp` commands in the examples above.
...
//
Figure 18 below shows the outcome upon executing `list pet`.
...
//
Executing the `schedule` command will result in an appointment card being created like figure 19 below.
...
//
Figure 20 below shows the status of the program before executing the command given in the example above.

.Current state of pet and appointment status in the program.
image::userguide_scheduleCommand_image.PNG[width="1000"]

//
Executing the command `addappttopet appt/1 p/1` will result in the following output like figure 21 below.
...
//
Figure 22 below shows the current state of the program before executing the command given in the example above.
...
//
Figure 23 below shows the outcome after executing the command.
...
//
The figure 24 below shows the results of executing the `deletep 1` command.
...
//
Figure 25 below shows the current state of your program before executing `unschedule 1`.

.The current status of appointments in your program.
image::userguide_unscheduleCommand_image.PNG[width="1000"]

//
Figure 26 below shows the outcome after executing the command.
...
//
Figure 27 below shows the current state of your program before executing `removeapptfrompet appt/1`.
...
//
Figure 28 below shows the outcome after executing the command.
...
//
Figure 29 below shows the current state of program before executing `removevettechfromappt 1`.

.The appointment card with assigned vet technician Rebecca Ling
image::userguide_addvettechtoapptCommand_image2.PNG[width="1000"]

//
Calling the command will result in the output shown in figure 30 below.
...
//
Figure 31 below shows the current state of the program before executing `reschedule 1 tm/1530`.
...
//
Figure 33 below shows the current state of the pet list before sorting it.
...
//
Figure 34 below shows the outcome after executing `sortp`.
